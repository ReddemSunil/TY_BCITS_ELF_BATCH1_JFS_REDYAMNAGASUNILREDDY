...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%String errMsg=(String)request.getAttribute("errMsg"); 
    	ConsumerCurrentBill bill=(ConsumerCurrentBill) request.getAttribute("bill");
    %>
...
<body class="body">
    <div class="border" style="margin-left: 32%;">
                  ...
                  <form method="post" action="./paymentSuccessfullPage" >
                    ...
                    <div class='form-row'>
                      <div class='col-xs-12 form-group required'>
                        ...
                        <input class='form-control card-number' size='50' type="tel"required>
                      </div>
                    </div>
                       <div class='form-row'>
                      <div class='col-xs-12 form-group required'>
                        <label class='control-label lable1'>Bill Amount</label>
                        <input class='form-control' size='50' value="<%=bill.getAmount()%>"disabled="disabled"">
                      </div>
                    </div>
                    <div class='form-row'>
                      <div class='col-xs-12 form-group required'>
                    ...
                    <div class='form-row'>
                      <div class='col-xs-4 form-group cvc required'>
                        ...
                        <input class='form-control card-cvc' placeholder='ex. 311' size='5' type="tel"required>
                      </div>
